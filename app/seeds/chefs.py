...
def seed_chefs():
    ...
    chef2 = Chef(food_type_id=2, price=60, bio="Cooking is cool. Hire me for all your family events.",
                 profile_image="https://i.postimg.cc/tCnKnd2K/female-profile1.jpg")
    chef3 = Chef(food_type_id=3, price=55, bio="Cooking is life for me. I love it more than anything else in the world. That's why my food is world class.",
                 profile_image="https://i.postimg.cc/QMhwz2hD/male-profile1.jpg")
    chef4 = Chef(food_type_id=4, price=10, bio="You gotta hire me man. I know you'll be the first one to like my food.",
